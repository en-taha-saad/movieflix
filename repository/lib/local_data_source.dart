import 'package:data/local/database/entity/movies_dtos/now_playing_movie_dto.dart';
import 'package:data/local/database/entity/movies_dtos/popular_movie_dto.dart';
import 'package:data/local/database/entity/movies_dtos/top_rated_movies_dto.dart';
import 'package:data/local/database/entity/movies_dtos/upcoming_movies_dto.dart';
import 'package:data/local/database/entity/series_dtos/airing_today_series_dto.dart';
import 'package:data/local/database/entity/series_dtos/on_the_air_series_dto.dart';
import 'package:data/local/database/entity/series_dtos/popular_series_dto.dart';
import 'package:data/local/database/entity/series_dtos/top_rated_series_dto.dart';
import 'package:data/local/database/entity/user_dto.dart';
