...
import 'package:movieflix/data/local/local_data_source_imp.dart' as _i14;
import 'package:movieflix/data/local/preference_data_source_imp.dart' as _i15;
...
import 'package:movieflix/data/local/shared_prefs/shared_prefs_imp.dart'
    as _i10;
import 'package:movieflix/data/remote/api_error_handler.dart' as _i12;
import 'package:movieflix/data/remote/api_error_handler_imp.dart' as _i3;
import 'package:movieflix/data/remote/api_service.dart' as _i17;
import 'package:movieflix/data/remote/authorization_interceptor.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i12.ApiErrorHandler>(
        dataSourceModule.bindAPIErrorHandler(gh<_i3.ApiErrorHandlerImpl>()));
    gh.factory<_i13.AuthorizationInterceptor>(() =>
        _i13.AuthorizationInterceptor(sharedPrefs: gh<_i9.SharedPrefs>()));
    gh.factory<_i14.LocalDataSourceImpl>(() => _i14.LocalDataSourceImpl(
          gh<_i6.MovieDao>(),
          gh<_i11.UserDao>(),
          gh<_i7.SeriesDao>(),
        ));
    gh.factory<_i15.PreferencesDataSourceImpl>(
        () => _i15.PreferencesDataSourceImpl(gh<_i8.SharedPreferences>()));
    gh.factory<_i16.RemoteDataSourceImpl>(() => _i16.RemoteDataSourceImpl(
          gh<_i17.APIService>(),
          gh<_i12.ApiErrorHandler>(),
        ));
    gh.singleton<_i18.LocalDataSource>(
        dataSourceModule.bindLocalDataSource(gh<_i14.LocalDataSourceImpl>()));
    gh.singleton<_i19.PreferencesDataSource>(dataSourceModule
        .bindPreferencesDataSource(gh<_i15.PreferencesDataSourceImpl>()));
